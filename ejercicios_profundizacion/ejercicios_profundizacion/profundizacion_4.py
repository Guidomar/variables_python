...
nombre_padre1= (str(input("Introduczca nombre completo padre_1: ")))
nombre_padre2= (str(input("Introduczca nombre completo padre_2: ")))
nombre_hijo= (str(input("Introduczca nombre hijo: ")))

#Split nombre completo padre_1
nombre_1,apellido_1 = nombre_padre1.split(",")
print(nombre_1,apellido_1)

#Split nombre completo padre_2
nombre_2,apellido_2 = nombre_padre2.split(",")
