...
nombre_completo= (str(input("Introduce el nombre completo: ")))
num_documento= (int(input("Introduce el DNI: ")))
edad= (int(input("Introduce la edad: ")))
altura = (float(input("Introduce la altura en metros: ")))
print(f"El nombre completo es {nombre_completo} y el Nro de D.N.I es {num_documento}")
print(f"El nombre completo es {nombre_completo}, la edad es {edad} y la altura es {altura} mts")
